...
/**
 * Found here: https://stackoverflow.com/questions/"8490084"/trying-to-write-an-irc-client-but-struggling-to-find-a-good-resource-regarding-c
 * 
 *
 */
public enum Reply {
    ...
    // reply ids
        ...
        private String numCode(){return numCode;}
        
        Reply(String numericCode)
        {
            this.numCode = numericCode;
        } 
      // eo enum Reply
